...
def react_post_perm(data,object_id,type_react, proxy=None):
    ...
    try:
        ...
        if response_json.get('data', {}).get('feedback_react') is not None:
            ...
            prints(255, 0, 0, f"Lỗi khi thả cảm xúc (perm): Phản hồi không hợp lệ. {response.text}")
            return False
    except Exception as e:
        prints(255, 0, 0, f"Lỗi khi thả cảm xúc (perm): {e}")
        return False
...
def react_post_defaul(data,object_id,type_react, proxy=None):
    ...
    try:
        ...
        if response_json.get('data', {}).get('feedback_react') is not None:
            ...
            prints(255, 0, 0, f"Lỗi khi thả cảm xúc (default): Phản hồi không hợp lệ. {response.text}")
            return False
    except Exception as e:
        prints(255, 0, 0, f"Lỗi khi thả cảm xúc (default): {e}")
        return False
...
def react_stories(data,object_id, proxy=None):
    ...
    try:
        ...
        if response.get('data', {}).get('story_send_reply') is not None:
            return True
        else:
            prints(255, 0, 0, f"Lỗi khi react story: Phản hồi không hợp lệ. {response}")
            return False
    except Exception as e:
        prints(255, 0, 0, f"Lỗi khi react story: {e}")
        return False
...
def comment_fb(data,object_id,msg, proxy=None):
    ...
    try:
        ...
        if 'data' in response and 'comment_create' in response['data'] and 'feedback_comment_edge' in response['data']['comment_create']:
            comment_node = response['data']['comment_create']['feedback_comment_edge'].get('node', {})
        ...
        prints(255,0,0,f"Lỗi khi comment: Phản hồi không xác nhận được comment. {response}")
        return False
    except Exception as e:
...
def dexuat_fb(data,object_id,msg, proxy=None):
    ...
    try:
        ...
        prints(255,0,0,f"Lỗi khi đánh giá Fanpage: Phản hồi không hợp lệ. {response_json}")
        return False
    except Exception as e:
        prints(255,0,0,f'Lỗi khi đánh giá Fanpage: {e}')
        return False
